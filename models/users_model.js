...
exports.editSantri = (res, req, next) => {
  let formData = {
    nama_santri: req.body.nama_santri,
    tgl_lahir: req.body.tgl_lahir,
    telp: '+62'+req.body.telp,
...
exports.readData = (res, req) => {
  ...
  s.tgl_lahir as tgl_lahir_s,\
  s.telp as telp_s,\
  s.alamat as alamat_s,\
  s.gol_darah as gol_darah_s,\
  m.tgl_lahir as tgl_lahir_m,\
  m.telp as telp_m,\
  m.alamat as alamat_m,\
  m.gol_darah as gol_darah_m FROM user u\
